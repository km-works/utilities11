package kmw.utilities.core.base;

import com.google.common.base.Joiner;
import kmw.utilities.core.arrays.ArrayServiceUtil;
import static kmw.utilities.core.strings.StringPool.*;
import kmw.utilities.core.strings.StringServiceUtil;
...
public final class ClassServiceUtil {

    private ClassServiceUtil() {}
     ...
     */
    public static final char PACKAGE_SEPARATOR_CHAR = Chars_.DOT;
     ...
     */
    public static final char INNER_CLASS_SEPARATOR_CHAR = Chars_.DOLLAR;
    ...
    public static String getShortClassName(String className) {
        if (StringServiceUtil.isNullOrEmpty(className)) {
            return Strings_.EMPTY;
        }
        ...
        if (className.startsWith("[")) {
            while (className.charAt(0) == Chars_.LEFT_SQUARE) {
                className = className.substring(1);
                arrayPrefix.append("[]");
            }
            // Strip Object type encoding
            if (className.charAt(0) == 'L' && className.charAt(className.length() - 1) == Chars_.SEMICOLON) {
    ...
    public static String getAbbreviatedName(String className, int len) {
        ...
        int packageLevels = StringServiceUtil.countMatches(className, Pattern.compile("\\."));
        String[] output = new String[packageLevels + 1];
        int endIndex = className.length() - 1;
        for (int level = packageLevels; level >= 0; level--) {
            int startIndex = className.lastIndexOf(PACKAGE_SEPARATOR_CHAR, endIndex);
        ...
        return Joiner.on(".").join(output); //StringServiceUtils.join(output, '.');
    }
    ...
    public static boolean isAssignable(Class<?>[] classArray, Class<?>[] toClassArray, final boolean autoboxing) {
        if (ArrayServiceUtil.isSameLength(classArray, toClassArray) == false) {
            return false;
        }
        if (classArray == null) {
            classArray = ArrayServiceUtil.EMPTY_CLASS_ARRAY;
        }
        if (toClassArray == null) {
            toClassArray = ArrayServiceUtil.EMPTY_CLASS_ARRAY;
        }
    ...
    public static Class<?> getClass(final String className, final boolean initialize) throws ClassNotFoundException {
        ...
        final ClassLoader loader = contextCL == null ? ClassServiceUtil.class.getClassLoader() : contextCL;
    ...
    private static String toCanonicalName(String className) {
        className = StringServiceUtil.removeWhitespace(className);
        if (className == null) {
    ...
    public static Class<?>[] toClass(final Object... array) {
        if (array == null) {
            ...
            return ArrayServiceUtil.EMPTY_CLASS_ARRAY;
        }
